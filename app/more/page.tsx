  ...
  return (
    <div className="mx-auto max-w-3xl space-y-5">
      ...
      <section className="grid gap-3 sm:grid-cols-2">
        {qrItems.map((item) => (
          <MoreLink key={item.href} {...item} t={t} />
        ))}
      </section>
...
function MoreLink({
  ...
  href: string;
  labelKey: "tradeQr.title" | "friendQr.title" | "teams.title" | "duplicates.title" | "spending.title" | "help.title" | "about.title" | "settings.title";
  ...
  return (
    ...
    >
      ...
      <span className="min-w-0 flex-1">
        <span className="block font-black">{t(labelKey)}</span>
