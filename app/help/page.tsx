    ...
    <div className="mx-auto max-w-3xl space-y-5">
      <Card className="shadow-lift">
        <div className="flex items-start gap-3">
          ...
          <div>
            <h1 className="text-3xl font-black text-ink dark:text-white">{t("help.title")}</h1>
      ...
      <section className="space-y-2">
        {helpSections.map((section, index) => (
          <details
            ...
            open={index === 0}
          >
            <summary className="cursor-pointer text-base font-black text-ink dark:text-white">
              {t(section.titleKey)}
            </summary>
            <p className="mt-2 text-sm font-semibold leading-6 text-neutral-600 dark:text-neutral-400">
              {t(section.bodyKey)}
