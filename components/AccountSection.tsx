...
import { runManualSync, signInWithGoogle, signOutLocally, useAuthSyncStore } from "@/lib/authSyncStore";
      ...
      <div className="space-y-4">
        ...
        {!user ? (
          ...
          <div className="space-y-3">
            ...
            {isDev ? (
              <Button className="w-full" onClick={runManualSync} disabled={status === "syncing"}>
                <RefreshCw size={18} />
                Dev sync
              </Button>
            ) : null}
